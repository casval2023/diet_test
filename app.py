...
# 問題と答えのリスト
questions_j = [
    {"question": "問1：A～Cに当てはまる言葉を下記の語群から選び、文章を完成させましょう。人が痩せる仕組みで考えられ理由は大きく二つと考えられます。一つは（　A　）、もう一つは（　B　）にあるということ。
この二つの理由は必ずしも、からだにとって「良い状態」ではない。一般的にダイエットとは、この二つの理由を人為的に作り出して痩せさせていくものでその負担は、からだにとってどのくらいのものなのかを知り、（　C　）なダイエットをしなくてはいけない。", "choices": ["①A:発汗,B:飢餓状態,C:健康的", "②A:臓器の故障,B:飢餓状態,C:活動的", "③A:臓器の故障,B:代謝異常,C:健康的", "④A:臓器の故障,B:飢餓状態,C:健康的"], "answer": "④A:臓器の故障,B:飢餓状態,C:健康的"},
